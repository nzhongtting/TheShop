              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter your Auth I.D & password to login</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="{{ route('login') }}" novalidate>
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Auth I.D</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">@</span>
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" value="{{ old('email') }}" autocomplete="email" autofocus required>
							@error('email')
